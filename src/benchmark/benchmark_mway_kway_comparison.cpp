...
constexpr auto USABLE_L3_CACHE = L3_CACHE_SIZE;
...
static void BM_MWAY_MERGE(benchmark::State& state) {
  ...
  for (auto iteration = size_t{0}; iteration < warmup_iterations; ++iteration) {
    ...
    auto multiway_merger =
        multiway_merging::MultiwayMerger2<choose_count_per_vector(), SortingType>(sorted_bucket_ptrs, cache_per_thread);
...
constexpr auto CACHE_SIZE = SYSTEM_L2_CACHE_SIZE;
constexpr auto DOUBLE_CACHE_SIZE = 2 * CACHE_SIZE;
constexpr auto TRIPLE_CACHE_SIZE = 3 * CACHE_SIZE;

BENCHMARK(BM_MWAY_MERGE)
    ->Args({4, NUM_TUPLES, CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({8, NUM_TUPLES, CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({16, NUM_TUPLES, CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({32, NUM_TUPLES, CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({64, NUM_TUPLES, CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({128, NUM_TUPLES, CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({256, NUM_TUPLES, CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({512, NUM_TUPLES, CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({1024, NUM_TUPLES, CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({2048, NUM_TUPLES, CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();

BENCHMARK(BM_MWAY_MERGE)
    ->Args({4, NUM_TUPLES, DOUBLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({8, NUM_TUPLES, DOUBLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({16, NUM_TUPLES, DOUBLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({32, NUM_TUPLES, DOUBLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({64, NUM_TUPLES, DOUBLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({128, NUM_TUPLES, DOUBLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({256, NUM_TUPLES, DOUBLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({512, NUM_TUPLES, DOUBLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({1024, NUM_TUPLES, DOUBLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({2048, NUM_TUPLES, DOUBLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();

BENCHMARK(BM_MWAY_MERGE)
    ->Args({4, NUM_TUPLES, TRIPLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({8, NUM_TUPLES, TRIPLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({16, NUM_TUPLES, TRIPLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({32, NUM_TUPLES, TRIPLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({64, NUM_TUPLES, TRIPLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({128, NUM_TUPLES, TRIPLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({256, NUM_TUPLES, TRIPLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({512, NUM_TUPLES, TRIPLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({1024, NUM_TUPLES, TRIPLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({2048, NUM_TUPLES, TRIPLE_CACHE_SIZE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();

BENCHMARK(BM_MWAY_MERGE)
    ->Args({4, NUM_TUPLES, USABLE_L3_CACHE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({8, NUM_TUPLES, USABLE_L3_CACHE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({16, NUM_TUPLES, USABLE_L3_CACHE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({32, NUM_TUPLES, USABLE_L3_CACHE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({64, NUM_TUPLES, USABLE_L3_CACHE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({128, NUM_TUPLES, USABLE_L3_CACHE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({256, NUM_TUPLES, USABLE_L3_CACHE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({512, NUM_TUPLES, USABLE_L3_CACHE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({1024, NUM_TUPLES, USABLE_L3_CACHE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
BENCHMARK(BM_MWAY_MERGE)
    ->Args({2048, NUM_TUPLES, USABLE_L3_CACHE})
    ->Unit(benchmark::kMillisecond)
    ->Iterations(5)
    ->UseManualTime();
